...
const ProjectsSection = () => {
  const projects = [
    ...
    },
    {
      title: "Bihar Website",
      description:
        "A responsive website designed to showcase the beauty of Bihar, including its history, culture, and tourist destinations. The project highlights user-friendly navigation, attractive layouts, and an organized structure to give visitors a smooth browsing experience.",
